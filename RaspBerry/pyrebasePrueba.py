...
firebaseConfig = {
    ...
    "databaseURL": "https://arquiiiweb-default-rtdb.firebaseio.com/",
...
db.child("Branch Push").child("Employee").child("Lara").set(data)
 #set se usa para que tenga una llame primaria dada por el programador
print("set enviado")

#Update
data = {"name":"John", "age":20, "addres":["New York", "Los Angeles"] }
db.child("Branch Update").child("Employee").child("Lara").push(data)
print("push enviado")
...
print("Update Enviado")
 #update especificamente de algo
